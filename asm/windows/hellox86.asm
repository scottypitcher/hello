...
;
;  Build HELLOX86.EXE with:
;
;  nasm -fwin32 hellox86.asm
;  link /subsystem:console /nodefaultlib /entry:_start hellox86.obj kernel32.lib
;
;  Optional:
;
;  Add "/align:16" to the LINK command above to shrink HELLOX86.EXE
;  from 3072 bytes down to 784.
;
;  A free alternative to Microsoft LINK is GoLink from http://www.godevtool.com/.
;
;  golink /files /console /entry _start hellox86.obj kernel32.dll
;
