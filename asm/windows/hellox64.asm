...
;  and the 64-bit LINK.EXE from Microsoft Visual C++ (or Visual Studio).
;
;  Build HELLOX64.EXE with:
;
;  nasm -fwin32 hellox64.asm
;  link /subsystem:console /nodefaultlib /entry:_start hellox64.obj kernel32.lib
;
;  A free alternative to Microsoft LINK is GoLink from http://www.godevtool.com/.
;
;  golink /files /console /entry _start hellox64.obj kernel32.dll
;
